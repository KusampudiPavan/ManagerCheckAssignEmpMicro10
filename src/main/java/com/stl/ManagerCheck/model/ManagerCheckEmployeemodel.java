package com.stl.ManagerCheck.model;
...
@Entity
@Table(name="employee")
public class ManagerCheckEmployeemodel {
	...
	public ManagerCheckEmployeemodel() {
		
	}


	public ManagerCheckEmployeemodel(Long employeeid, String firstname, String lastname, String email, String phonenumber,
